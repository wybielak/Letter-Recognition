...
image_Folder_Path = 'E:\Studia\\1. Systemy sztucznej inteligencji\projekt\images' #your path to target folder to save images. Note: Path should have 26 empty folder with name as alphabets
